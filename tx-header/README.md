...
Генерация завершена:
  ...
  • Всего real tx:        82971
  • Общий размер (байты, несжатый файл):    7582387
  • Средний размер tx:       142.5 байт
  • Средний размер real tx:       91.4 байт
Сгенерировано 53205 транзакций → txs.bin
Алгоритм zstd       → txs.bin.zstd (5475321 байт)
   Коэффициент: 1.38x   Экономия: 27.8%
   Сжатие:     44 мс    Распаковка:    3 мс

Алгоритм zstd-dict  → txs.bin.zstd-dict.dict (5475458 байт)
   Коэффициент: 1.38x   Экономия: 27.8%
   Сжатие:     29 мс    Распаковка:    4 мс

Алгоритм lz4        → txs.bin.lz4 (5667738 байт)
   Коэффициент: 1.34x   Экономия: 25.3%
   Сжатие:     28 мс    Распаковка:   13 мс

Алгоритм s2         → txs.bin.s2 (5842780 байт)
   Коэффициент: 1.30x   Экономия: 22.9%
   Сжатие:      6 мс    Распаковка:    3 мс

Алгоритм gzip       → txs.bin.gzip (5475253 байт)
   Коэффициент: 1.38x   Экономия: 27.8%
   Сжатие:     88 мс    Распаковка:   30 мс
